...
CREATE TABLE IF NOT EXISTS $table_prefixaxcosmetics_cosmetics (id INTEGER PRIMARY KEY AUTOINCREMENT, owner_id INTEGER, cosmetic_type_id INTEGER, counter INTEGER, color INTEGER, acquired BIGINT, equipped BOOLEAN, permission BOOLEAN);